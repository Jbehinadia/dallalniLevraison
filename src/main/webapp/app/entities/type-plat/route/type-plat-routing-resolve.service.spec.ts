...
describe('TypePlat routing resolve service', () => {
  ...
  let resultTypePlat: ITypePlat | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new ITypePlat if id is not provided', () => {
      // GIVEN
      ...
      expect(resultTypePlat).toEqual(new TypePlat());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as TypePlat })));
      mockActivatedRouteSnapshot.params = { id: 123 };
